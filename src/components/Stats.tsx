...
const statIcons = [Users, GraduationCap, ClipboardCheck, MessageSquare];
            ...
            <div className="relative px-6 py-10 sm:px-10 sm:py-12">
              ...
              <div className="relative grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
                <ScrollReveal animation="fade-right">
                  <div>
                    <p className="text-sm font-semibold uppercase tracking-widest text-teal-200">{t.stats.badge}</p>
                  ...
                  {t.stats.items.map((stat, index) => {
                    ...
                    return (
                      <ScrollReveal key={index} animation="fade-up" delay={index * 120}>
                        <article className="rounded-2xl border border-white/15 bg-white/8 p-4 backdrop-blur-sm">
